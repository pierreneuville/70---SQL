...
select 			    mtaw.person_number
		...
		left join my_plan_date pld on 1=1
where not (mtaw.effective_start_date=mtaw.prev_eff_start_date_mtaw and  mtaw.effective_end_date= mtaw.next_eff_end_date_mtaw)
and mtaw.effective_start_date >= pld.start_date
